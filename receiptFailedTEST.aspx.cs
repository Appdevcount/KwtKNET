...
{
    public partial class receiptFailed :  System.Web.UI.Page//BasePage
    {
       public String language = "ar-KW"; // "en-us";
        ...
        KnetPayment.Activity<KnetPayment.PayResp> activity = new KnetPayment.Activity<KnetPayment.PayResp>()
        {
            ...
            LogDestination = KnetPayment.LogDestination.Database,
            NotifyingMethod = KnetPayment.LogNotifyingMode.None
        };
