...
namespace KnetPayment
{
    public class logging
    {
        ...
        public VerifyReceiptDetailsforGCSSite VerifyReceiptDetailsforGCSSite(String TempReceiptNumber, string Mobile, string CustEmail, string SecurityCode)
        {
            String conString = ConfigurationManager.ConnectionStrings["conStr"].ConnectionString;
            ...
            {
                Message = (string)(CheckReceiptcommand.Parameters["@Message"].Value),
        ...
        public DataSet GetPaymentDetailsforGCSSite(String TempReceiptNumber, string Mobile, string CustEmail, bool PaymentInitCall)
        {
            DataSet paymentDetails = new DataSet();
